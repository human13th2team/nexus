...
import type { WorkerContractRequest, WorkerContractType } from '../components/workerTypes';
      ...
      <section className="mx-auto w-full max-w-7xl px-8 py-14">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_420px]">
          <div className="space-y-8">
            <ContractTypeSelector value={form.contractType} onChange={updateContractType} />
