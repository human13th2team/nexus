...
export default function StoreMapClient({ kakaoApiKey, initialIndustries, initialRegions }: any) {
  ...
  useEffect(() => {
    ...
    const level =
      span > 1.0 ? 10 : span > 0.5 ? 9 : span > 0.2 ? 8 : span > 0.1 ? 7 : span > 0.05 ? 6 : 5;
  ...
  return (
    <div
      className="h-full w-full flex flex-col bg-white overflow-hidden font-inter border-b border-slate-200"
                ...
                <>
                  <div className="space-y-4">
                    <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 flex justify-between items-end">
                      <div>
                        <p className="text-[9px] font-black text-slate-500 mb-1 uppercase">
                          총 업소
                        </p>
                    ...
                    <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100 flex justify-between items-end">
                      <div>
                        ...
                        <p className="text-2xl font-black text-slate-950">{avg}개</p>
                      </div>
                    </div>
                  </div>
