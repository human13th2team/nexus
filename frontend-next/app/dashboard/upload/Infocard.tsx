...
const Infocard: React.FC<InfocardProps> = ({ className }) => {
  return (
    <div
      className={`p-6 rounded-2xl bg-white/10 backdrop-blur-md border border-white/20 shadow-xl ${className}`}
    >
      ...
      <p className="text-gray-300 text-sm leading-relaxed mb-4">
        정확한 데이터 추출을 위해 영수증 이미지를 선명하게 촬영하여 업로드해주세요. AI 모델이
        품목명, 단가, 수량을 자동으로 인식하여 분석합니다.
      </p>
